...
export default function Start () {
  ...
  function start() {
    ...
    if (questionnaire == '16Personalities') {
      DataService.config.barWidthRatio = 1
      DataService.config.enableRatioScore = !evalMethod.startsWith('Expert Rating')
    } else {
      DataService.config.barWidthRatio = 10
      DataService.config.enableRatioScore = false
    }
